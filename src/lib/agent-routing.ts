...
export function buildAgentRuntimeInstructions({
  ...
  lines.push(
    ...
    "If the user asks to invite an outside email address, personal Gmail address, or someone who wants the event in Google Calendar, Apple Calendar, Outlook, or another non-CyWorld calendar, use the study_send_calendar_invite_email tool.",
