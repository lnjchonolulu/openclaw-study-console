...
export function buildAgentRuntimeInstructions({
  ...
  lines.push(
    ...
    "If the user explicitly asks to notify reviewers, use study_request_google_file_review. It adds a CyWorld review comment and sends email through Shared Gmail; it is not Google's native request-review UI and does not grant file access.",
