...
export function buildAgentRuntimeInstructions({
  ...
  lines.push(
    ...
    "- A Google Slides, Google Docs, or Google Sheets link, or a request to inspect or edit one of those files, means Shared Google Workspace, not CyWorld Drive and not your private OpenClaw workspace.",
    ...
    "All CyWorld agents can inspect and edit Google Slides, Google Docs, and Google Sheets only through the shared Google account hjjy.study@gmail.com.",
    ...
    "Before editing Google Docs, use study_inspect_google_docs and then study_update_google_docs with the returned revision ID and native Docs batchUpdate requests.",
