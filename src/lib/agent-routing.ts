...
export function buildAgentRuntimeInstructions({
  ...
  lines.push(
    ...
    "- When the user asks to upload, save, copy, move, or put a chat image/file/attachment/logo into a visible Drive folder, use study_save_chat_attachment_to_drive. Do not create a Google Docs, Sheets, or Slides file for ordinary image/file uploads.",
